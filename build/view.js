  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
			...
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(" ", headingtitle?.typo).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(" ", actorNames?.typo).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(" ", audioTime?.typo).googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(" ", playerStyle?.playerTitle?.typo).googleFontLink}

			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(audioTitleSl, headingtitle?.typo).styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(audioArtistSl, actorNames?.typo).styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(audioTimeSl, audioTime?.typo).styles}
			...
			${audioTitleSl}{
			  ...
			  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(headingtitle?.margin)};	  
			}
			${audioArtistSl}{
			  color: ${actorNames?.colors};
			  margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(actorNames?.margin)};	  
			}
			${audioTimeSl}{
...
/***/ "./src/theme/PlayerRating/PlayerRating.js":
/*!************************************************!*\
  !*** ./src/theme/PlayerRating/PlayerRating.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _PlayerRatingStyle_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PlayerRatingStyle.css */ "./src/theme/PlayerRating/PlayerRatingStyle.css");
...
const PlayerRating = ({
  ...
  }, audioFileName || `Player ${index + 1}`), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "stars"
  }, [1, 2, 3, 4, 5].map(star => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    key: star,
    onClick: e => {
      e.stopPropagation();
      handleRate(star);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PlayerRating);
...
/* harmony import */ var _themeOneStyle_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./themeOneStyle.css */ "./src/theme/themeOneStyle.css");
...
const ThemeOne = ({
  ...
  const [playerTime, setPlayerTime] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(currentTime || 0);
  const [playerPlaying, setPlayerPlaying] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(isPlaying || false);
  ...
  }, formatTime(playerTime), " / ", formatTime(audioDuration))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/***/ "./src/theme/PlayerRating/PlayerRatingStyle.css":
/*!******************************************************!*\
  !*** ./src/theme/PlayerRating/PlayerRatingStyle.css ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
